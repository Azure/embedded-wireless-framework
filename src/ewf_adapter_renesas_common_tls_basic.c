 ...
 * @details
 * The Embedded Wireless Framework Renesas common TLS basic API implementation
...
{
    ewf_adapter_renesas_common_tls_basic_init,
    ewf_adapter_renesas_common_tls_basic_clean,
};
