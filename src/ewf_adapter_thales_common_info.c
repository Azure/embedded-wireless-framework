...
{
    ewf_adapter_thales_common_info,
    ewf_adapter_thales_common_get_ipv4_address,
    ewf_adapter_thales_common_get_ipv4_netmask,
    ewf_adapter_thales_common_get_ipv4_gateway,
    ewf_adapter_thales_common_get_ipv4_dns,
    NULL,
    NULL,
    NULL,
};
...
ewf_result ewf_adapter_thales_common_info(ewf_adapter* adapter_ptr)
{
    ...
    /* Monitoring Serving Cell */
    if (ewf_result_failed(result = ewf_interface_send_command(interface_ptr, "AT^SMONI\r"))) return result;
    if (ewf_result_failed(result = ewf_interface_drop_response(interface_ptr))) return result;

    /* Internet Service Information */
    if (ewf_result_failed(result = ewf_interface_send_command(interface_ptr, "AT^SISI?\r"))) return result;
    if (ewf_result_failed(result = ewf_interface_drop_response(interface_ptr))) return result;
...
ewf_result ewf_adapter_thales_common_get_ipv4_gateway(ewf_adapter* adapter_ptr, uint32_t * gateway_ptr)
{
    ...
    return ewf_adapter_thales_common_get_ipv4_address(adapter_ptr, gateway_ptr);
}
