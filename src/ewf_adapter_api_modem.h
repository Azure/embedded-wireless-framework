...
typedef struct _ewf_adapter_modem_api
{
    ...
    ewf_result(*clock_set)(ewf_adapter* adapter_ptr, ewf_adapter_modem_time * time_info_ptr);
    ewf_result(*clock_read)(ewf_adapter* adapter_ptr, ewf_adapter_modem_time * time_info_ptr);
    ewf_result(*alarm_set)(ewf_adapter* adapter_ptr,  ewf_adapter_modem_time * alarm_info_ptr, uint8_t n, uint32_t type, const char * text_str,  uint32_t text_len, const char * recurr_str, uint32_t recurr_len, bool silent);
