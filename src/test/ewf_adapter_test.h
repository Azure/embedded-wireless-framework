...
#ifndef EWF_ADAPTER_TEST_TCP_RECV_SLEEP_SECS
#define EWF_ADAPTER_TEST_TCP_RECV_SLEEP_SECS                    0
#endif
...
#ifndef EWF_ADAPTER_TEST_UDP_RECV_SLEEP_SECS
#define EWF_ADAPTER_TEST_UDP_RECV_SLEEP_SECS                    0
#endif
