 ...
 * @brief The Embedded Wireless Framework ESPRESSIF ESP8285 adapter API
 ****************************************************************************/

#include "ewf_adapter_espressif_esp8285.h"
#include "ewf_adapter_espressif_common.c"

ewf_adapter_api_control ewf_adapter_espressif_esp8285_api_control =
{
    ewf_adapter_espressif_esp8285_start,
    ewf_adapter_espressif_esp8285_stop,
};
