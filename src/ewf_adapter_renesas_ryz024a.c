 ...
 * @brief The Embedded Wireless Framework Renesas RYZ024A driver implementation
 ****************************************************************************/

#include "ewf_adapter_renesas_ryz024a.h"

ewf_adapter_api_control ewf_adapter_renesas_ryz024a_api_control =
{
    ewf_adapter_renesas_ryz024a_start,
    ewf_adapter_renesas_ryz024a_stop,
};
