...
{
    ewf_adapter_renesas_common_info,
    ewf_adapter_renesas_common_get_ipv4_address,
    ewf_adapter_renesas_common_get_ipv4_netmask,
    ewf_adapter_renesas_common_get_ipv4_gateway,
    ewf_adapter_renesas_common_get_ipv4_dns,
    NULL,
    NULL,
    NULL,
};
