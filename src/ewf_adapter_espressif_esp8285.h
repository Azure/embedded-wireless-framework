 ...
 * @brief The Embedded Wireless Framework ESPRESSIF ESP8285 adapter driver
 ****************************************************************************/

#ifndef __ewf_adapter_espressif_esp8285__h__included__
#define __ewf_adapter_espressif_esp8285__h__included__
...
/************************************************************************//**
 * @defgroup group_configuration_adapter_espressif_esp8285 ESPRESSIF 8285 adapter configuration
 * @ingroup group_configuration
 * @brief ESPRESSIF 8285 adapter configuration
 * @{
 ****************************************************************************/
...
#if 1
#define EWF_ADAPTER_ESPRESSIF_ESP8285_TLS_BASIC_ENABLED (1)
#define EWF_ADAPTER_ESPRESSIF_ESP8285_TLS_ENABLED (0)
#else
#define EWF_ADAPTER_ESPRESSIF_ESP8285_TLS_BASIC_ENABLED (0)
#define EWF_ADAPTER_ESPRESSIF_ESP8285_TLS_ENABLED (1)
#endif
#endif

#ifndef EWF_ADAPTER_ESPRESSIF_ESP8285_TCP_ENABLED
#define EWF_ADAPTER_ESPRESSIF_ESP8285_TCP_ENABLED (1)
#endif

#ifndef EWF_ADAPTER_ESPRESSIF_ESP8285_UDP_ENABLED
#define EWF_ADAPTER_ESPRESSIF_ESP8285_UDP_ENABLED (1)
#endif

#if !defined(EWF_ADAPTER_ESPRESSIF_ESP8285_MQTT_ENABLED) && !defined(EWF_ADAPTER_ESPRESSIF_ESP8285_MQTT_BASIC_ENABLED)
#if 1
#define EWF_ADAPTER_ESPRESSIF_ESP8285_MQTT_BASIC_ENABLED (1)
#define EWF_ADAPTER_ESPRESSIF_ESP8285_MQTT_ENABLED (0)
#else
#define EWF_ADAPTER_ESPRESSIF_ESP8285_MQTT_BASIC_ENABLED (0)
#define EWF_ADAPTER_ESPRESSIF_ESP8285_MQTT_ENABLED (1)
#endif
#endif
...
/**
 * @defgroup group_adapter_espressif_esp8285_control Adapter control
 * @brief ESPRESSIF ESP8285 adapter control API
 * @{
 */

extern ewf_adapter_api_control ewf_adapter_espressif_esp8285_api_control;

ewf_result ewf_adapter_espressif_esp8285_start(ewf_adapter* adapter_ptr);
ewf_result ewf_adapter_espressif_esp8285_stop(ewf_adapter* adapter_ptr);

/** @} *** group_adapter_espressif_esp8285_control */

/**
 * @defgroup group_adapter_espressif_esp8285_urc URC handling
 * @brief ESPRESSIF ESP8285 adapter driver URC handling
 * @{
 */

ewf_result ewf_adapter_espressif_esp8285_urc_callback(ewf_interface* interface_ptr, uint8_t* buffer_ptr, uint32_t buffer_length);

/** @} *** group_adapter_espressif_esp8285_urc */

/**
 * @defgroup group_adapter_espressif_esp8285_info Adapter information
 * @brief ESPRESSIF ESP8285 adapter driver info API
 * @{
 */


#define ewf_adapter_espressif_esp8285_info                     ewf_adapter_espressif_common_info
#define ewf_adapter_espressif_esp8285_get_ipv4_address         ewf_adapter_espressif_common_get_ipv4_address
#define ewf_adapter_espressif_esp8285_get_ipv4_netmask         ewf_adapter_espressif_common_get_ipv4_netmask
#define ewf_adapter_espressif_esp8285_get_ipv4_gateway         ewf_adapter_espressif_common_get_ipv4_gateway
#define ewf_adapter_espressif_esp8285_get_ipv4_dns             ewf_adapter_espressif_common_get_ipv4_dns
...
/**
 * @defgroup group_adapter_espressif_esp8285_data ESPRESSIF 8285 driver internal data
 * @brief The ESPRESSIF 8285 adapter internal data structure
 * @{
 */

/** @brief The ESPRESSIF 8285 adapter driver data structure */
typedef struct _ewf_adapter_espressif_esp8285
{
...
} ewf_adapter_espressif_esp8285;

/** @} *** group_adapter_espressif_esp8285_data */

/**
 * @defgroup group_adapter_espressif_esp8285_declaration Adapter declaration and initialization
 * @brief ESPRESSIF 8285 adapter declaration macros
 * @{
 */

#ifdef EWF_PARAMETER_CHECKING
#define EWF_ADAPTER_ESPRESSIF_ESP8285_INITIALIZE_HEADER(adapter_ptr)                                                                                        \
do {                                                                                                                                                        \
...
(adapter_ptr)->struct_type = EWF_ADAPTER_TYPE_ESPRESSIF_ESP8285;                                                                                            \
} while(0)
#else
#define EWF_ADAPTER_ESPRESSIF_ESP8285_INITIALIZE_HEADER(adapter_ptr)
...
#if EWF_ADAPTER_ESPRESSIF_ESP8285_TCP_ENABLED
#define EWF_ADAPTER_ESPRESSIF_ESP8285_INITIALIZE_TCP_API(adapter_ptr)                                                                                       \
do {                                                                                                                                                        \
...
#if EWF_ADAPTER_ESPRESSIF_ESP8285_UDP_ENABLED
#define EWF_ADAPTER_ESPRESSIF_ESP8285_INITIALIZE_UDP_API(adapter_ptr)                                                                                       \
do {                                                                                                                                                        \
...
#if EWF_ADAPTER_ESPRESSIF_ESP8285_TLS_BASIC_ENABLED
#define EWF_ADAPTER_ESPRESSIF_ESP8285_INITIALIZE_TLS_BASIC_API(adapter_ptr)                                                                                 \
do {                                                                                                                                                        \
adapter_ptr->tls_basic_api_ptr = &ewf_adapter_espressif_common_api_tls_basic;                                                                               \
} while(0)
#else
#define EWF_ADAPTER_ESPRESSIF_ESP8285_INITIALIZE_TLS_BASIC_API(adapter_ptr)
#endif /* EWF_ADAPTER_ESPRESSIF_ESP8285_TLS_BASIC_ENABLED */

#if EWF_ADAPTER_ESPRESSIF_ESP8285_MQTT_BASIC_ENABLED
#define EWF_ADAPTER_ESPRESSIF_ESP8285_INITIALIZE_MQTT_BASIC_API(adapter_ptr)                                                                                \
do {                                                                                                                                                        \
adapter_ptr->mqtt_basic_api_ptr = &ewf_adapter_espressif_common_api_mqtt_basic;                                                                             \
} while(0)
#else
#define EWF_ADAPTER_ESPRESSIF_ESP8285_INITIALIZE_MQTT_BASIC_API(adapter_ptr)
#endif /* EWF_ADAPTER_ESPRESSIF_ESP8285_MQTT_BASIC_ENABLED */

 /**
 * @brief Declare a ESPRESSIF 8285 adapter
 ...
 */
#define EWF_ADAPTER_ESPRESSIF_ESP8285_STATIC_DECLARE(adapter_ptr, adapter_name_symb, message_allocator_ptr_param, data_allocator_ptr_param, interface_ptr_param) \
do {                                                                                                                                                        \
static ewf_adapter_espressif_esp8285 ewf_adapter_espressif_esp8285__implementation__##adapter_name_symb = {0};                                              \
static ewf_adapter ewf_adapter_espressif_esp8285__##adapter_name_symb = {0};                                                                                \
EWF_TOKENIZER_BASIC_STATIC_DECLARE(interface_ptr_param->tokenizer_ptr, ewf_adapter_espressif_esp8285__tokenizer__##adapter_name_symb);                      \
...
interface_ptr_param->urc_callback = ewf_adapter_espressif_esp8285_urc_callback;                                                                             \
ewf_adapter_espressif_esp8285__##adapter_name_symb.interface_ptr = interface_ptr_param;                                                                     \
ewf_adapter_espressif_esp8285__##adapter_name_symb.implementation_ptr = &(ewf_adapter_espressif_esp8285__implementation__##adapter_name_symb);              \
adapter_ptr = &(ewf_adapter_espressif_esp8285__##adapter_name_symb);                                                                                        \
...
EWF_ADAPTER_ESPRESSIF_ESP8285_INITIALIZE_TLS_BASIC_API(adapter_ptr);                                                                                        \
EWF_ADAPTER_ESPRESSIF_ESP8285_INITIALIZE_MQTT_BASIC_API(adapter_ptr);                                                                                       \
} while(0)

/** @} *** group_adapter_espressif_esp8285_declaration */

/************************************************************************//**
 * @} *** group_adapter_espressif_esp8285
 ****************************************************************************/
...
#endif /* __ewf_adapter_espressif_esp8285__h__included__ */
