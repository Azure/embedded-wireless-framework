...
#if EWF_ADAPTER_ESP_COMMON_TCP_ENABLED || EWF_ADAPTER_ESP_COMMON_UDP_ENABLED
...
#if EWF_ADAPTER_ESP_COMMON_MQTT_ENABLED
...
#if EWF_ADAPTER_ESP_COMMON_TLS_BASIC_ENABLED
...
#if EWF_ADAPTER_ESP_COMMON_MQTT_BASIC_ENABLED
...
#if EWF_ADAPTER_ESP_COMMON_UFS_ENABLED
    if (ewf_result_failed(result = ewf_adapter_espressif_common_ufs_stop(adapter_ptr)))
    {
...
#if defined(EWF_ADAPTER_ESP_COMMON_TCP_ENABLED) || defined(EWF_ADAPTER_ESP_COMMON_UDP_ENABLED)
