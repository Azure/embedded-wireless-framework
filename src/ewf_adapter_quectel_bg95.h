...
#ifdef EWF_CONFIG_ADAPTER_QUECTEL_BG95_ROOT_CA_CERTIFICATE_FILE_NAME
#define EWF_CONFIG_ADAPTER_QUECTEL_COMMON_ROOT_CA_CERTIFICATE_FILE_NAME      EWF_CONFIG_ADAPTER_QUECTEL_BG95_ROOT_CA_CERTIFICATE_FILE_NAME
#endif 

/** @brief User Certificate Authority certificate file name to be stored on the modem */
#ifdef EWF_CONFIG_ADAPTER_QUECTEL_BG95_USER_CA_CERTIFICATE_FILE_NAME
#define EWF_CONFIG_ADAPTER_QUECTEL_COMMON_USER_CA_CERTIFICATE_FILE_NAME      EWF_CONFIG_ADAPTER_QUECTEL_BG95_USER_CA_CERTIFICATE_FILE_NAME
#endif 

/**
 * @brief CA certificate index that will be used in the security/TLS profile configuration
 * This number will either be EWF_CONFIG_ADAPTER_QUECTEL_BG95_ROOT_CA_CERTIFICATE_FILE_NAME or
 * EWF_CONFIG_ADAPTER_QUECTEL_BG95_USER_CA_CERTIFICATE_FILE_NAME
 */
#ifdef EWF_CONFIG_ADAPTER_QUECTEL_BG95_CERTIFICATE_CA_FILE_NAME
#define EWF_CONFIG_ADAPTER_RENESAS_COMMON_CA_CERTIFICATE_FILE_NAME           EWF_CONFIG_ADAPTER_QUECTEL_BG95_CA_CERTIFICATE_FILE_NAME
#endif

/** @brief Client certificate file name to be stored on the modem */
#ifdef EWF_CONFIG_ADAPTER_QUECTEL_BG95_CLIENT_CERTIFICATE_FILE_NAME
#define EWF_CONFIG_ADAPTER_QUECTEL_COMMON_CLIENT_CERTIFICATE_FILE_NAME       EWF_CONFIG_ADAPTER_QUECTEL_BG95_CLIENT_CERTIFICATE_FILE_NAME
#endif 

/** @brief Client private key filename  */
#ifdef EWF_CONFIG_ADAPTER_QUECTEL_BG95_CLIENT_PRIVATE_KEY_FILE_NAME
#define EWF_CONFIG_ADAPTER_QUECTEL_COMMON_CLIENT_PRIVATE_KEY_FILE_NAME       EWF_CONFIG_ADAPTER_QUECTEL_BG95_CLIENT_PRIVATE_KEY_FILE_NAME
#endif 

/** @brief Trusted Certificate Authority certificate buffer name*/
#ifdef EWF_CONFIG_ADAPTER_QUECTEL_BG95_ROOT_CA_CERTIFICATE_BUFFER_NAME
#undef EWF_CONFIG_ADAPTER_QUECTEL_COMMON_ROOT_CA_CERTIFICATE_BUFFER_NAME
#define EWF_CONFIG_ADAPTER_QUECTEL_COMMON_ROOT_CA_CERTIFICATE_BUFFER_NAME    EWF_CONFIG_ADAPTER_QUECTEL_BG95_ROOT_CA_CERTIFICATE_BUFFER_NAME
#endif 

/** @brief User Certificate Authority certificate buffer name */
#ifdef EWF_CONFIG_ADAPTER_QUECTEL_BG95_USER_CA_CERTIFICATE_BUFFER_NAME
#undef EWF_CONFIG_ADAPTER_QUECTEL_COMMON_USER_CA_CERTIFICATE_BUFFER_NAME
#define EWF_CONFIG_ADAPTER_QUECTEL_COMMON_USER_CA_CERTIFICATE_BUFFER_NAME    EWF_CONFIG_ADAPTER_QUECTEL_BG95_USER_CA_CERTIFICATE_BUFFER_NAME
#endif 

/** @brief Client certificate pointing buffer name */
#ifdef EWF_CONFIG_ADAPTER_QUECTEL_BG95_CLIENT_CERTIFICATE_BUFFER_NAME
#undef EWF_CONFIG_ADAPTER_QUECTEL_COMMON_CLIENT_CERTIFICATE_BUFFER_NAME
#define EWF_CONFIG_ADAPTER_QUECTEL_COMMON_CLIENT_CERTIFICATE_BUFFER_NAME     EWF_CONFIG_ADAPTER_QUECTEL_BG95_CLIENT_CERTIFICATE_BUFFER_NAME
#endif 

/** @brief Client private key buffer name  */
#ifdef EWF_CONFIG_ADAPTER_QUECTEL_BG95_CLIENT_PRIVATE_KEY_BUFFER_NAME
#undef EWF_CONFIG_ADAPTER_QUECTEL_COMMON_CLIENT_PRIVATE_KEY_BUFFER_NAME
#define EWF_CONFIG_ADAPTER_QUECTEL_COMMON_CLIENT_PRIVATE_KEY_BUFFER_NAME     EWF_CONFIG_ADAPTER_QUECTEL_BG95_CLIENT_PRIVATE_KEY_BUFFER_NAME
#endif 
...
/************************************************************************//**
 * @defgroup group_adapter_quectel_bg95 Quectel BG95 modem adapter driver
...
EWF_TOKENIZER_BASIC_STATIC_DECLARE(interface_ptr_param->tokenizer_ptr, ewf_adapter_quectel_bg95__tokenizer__##adapter_name_symb);                               \
...
adapter_ptr->implementation_ptr = &(ewf_adapter_quectel_bg95__implementation__##adapter_name_symb);                                                             \
