...
ewf_interface_tokenizer_pattern* ewf_adapter_quectel_common_command_response_end_tokenizer_pattern_ptr = &ewf_adapter_quectel_common_command_response_end_tokenizer_pattern1;
...
ewf_interface_tokenizer_pattern* ewf_adapter_quectel_common_urc_tokenizer_pattern_ptr = &ewf_adapter_quectel_common_urc_tokenizer_pattern1;
...
ewf_interface_tokenizer_pattern* ewf_adapter_quectel_common_message_tokenizer_pattern_ptr = &ewf_adapter_quectel_common_message_tokenizer_pattern1;
