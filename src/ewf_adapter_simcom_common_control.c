...
ewf_result ewf_adapter_simcom_common_stop(ewf_adapter* adapter_ptr)
{
    ...
    if (ewf_result_failed(result = ewf_adapter_simcom_common_ufs_stop(adapter_ptr)))
    {
...
#if defined(EWF_ADAPTER_SIMCOM_COMMON_TCP_ENABLED) || defined(EWF_ADAPTER_SIMCOM_COMMON_UDP_ENABLED)
    if (ewf_result_failed(result = ewf_adapter_simcom_common_internet_stop(adapter_ptr)))
    {
...
#if EWF_ADAPTER_SIMCOM_COMMON_MQTT_ENABLED
    if (ewf_result_failed(result = ewf_adapter_simcom_common_mqtt_stop(adapter_ptr)))
    {
...
#if EWF_ADAPTER_SIMCOM_COMMON_TLS_BASIC_ENABLED
    if (ewf_result_failed(result = ewf_adapter_simcom_common_tls_basic_stop(adapter_ptr)))
    {
...
#if EWF_ADAPTER_SIMCOM_COMMON_MQTT_BASIC_ENABLED
    if (ewf_result_failed(result = ewf_adapter_simcom_common_mqtt_basic_stop(adapter_ptr)))
    {
