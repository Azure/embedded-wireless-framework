...
7. Upload the primary and secondary certificate files. (For this demo you can upload the same device certificate file device_cert.pem, which was generated previously for both the options)  
