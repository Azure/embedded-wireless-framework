...
openssl req -new -key device_key.pem -out device_.csr -subj "/CN=%1%"
openssl x509 -req -in device_.csr -CA ca_cert.pem -CAkey ca_key.pem -CAcreateserial -out device_cert.pem -days 365 -sha256 -extensions client_auth
