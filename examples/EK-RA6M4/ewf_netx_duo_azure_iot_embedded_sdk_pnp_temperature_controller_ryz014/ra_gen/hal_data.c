...
sci_uart_instance_ctrl_t     g_uart0_ctrl;
            ...
            {
                /* Baud rate calculated with 0.217% error. */ .semr_baudrate_bits_b.abcse = 0, .semr_baudrate_bits_b.abcs = 0, .semr_baudrate_bits_b.bgdm = 1, .cks = 0, .brr = 5, .mddr = (uint8_t) 226, .semr_baudrate_bits_b.brme = true
            };
            ...
            const sci_uart_extended_cfg_t g_uart0_cfg_extend =
            {
                ...
                .flow_control           = SCI_UART_FLOW_CONTROL_CTS,
                #if 0xFF != 0xFF
...
const timer_cfg_t gpt_cfg =
{
    ...
    /* Actual period: 30 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0xb2d05e00, .duty_cycle_counts = 0x59682f00, .source_div = (timer_source_div_t)0,
    .channel             = 0,
    .p_callback          = g_gpt_timer_cb,
    /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
