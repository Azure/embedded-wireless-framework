...
#include "ewf_adapter_simcom_sim7000.c"
...
void thread_sample_entry(ULONG param)
{
    ...
    EWF_ADAPTER_SIMCOM_SIM7000_STATIC_DECLARE(adapter_ptr, simcom_sim7000, message_allocator_ptr, NULL, interface_ptr);
    ...
    {
        EWF_LOG_ERROR("Failed to get the adapter info, ewf_result %d.\n", result);
        return;
    }
