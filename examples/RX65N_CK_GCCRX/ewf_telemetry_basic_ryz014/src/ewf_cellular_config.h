...
#define EWF_CELLULAR_CFG_UART_SCI_CH            (0)

/* Specify the port and pin of the RTS terminal */
#define EWF_CELLULAR_CFG_RTS_PORT               2
#define EWF_CELLULAR_CFG_RTS_PIN                2

/* Specify the port and pin of the RESET terminal */
#define EWF_CELLULAR_CFG_RESET_PORT             D
#define EWF_CELLULAR_CFG_RESET_PIN              0
...
EWF_CONFIG_SIM_APN                      "internet.telekom",
