...
/* Application Data
  ...
  Remarks:
    This structure should be initialized by the EWF_INFO_Initialize function.

    Application strings and buffers are be defined outside this structure.
*/

EWF_INFO_DATA ewf_infoData;
...
void ewf_info_tx_bg96_shield_example(void);
void ewf_info_tx_bg96_shield_example(void)
{
    ewf_result result;
    ...
    EWF_ALLOCATOR_THREADX_STATIC_DECLARE(message_allocator_ptr, message_allocator, 8, 256);
...
/*******************************************************************************
  Function:
    void EWF_INFO_Initialize ( void )

  Remarks:
    See prototype in ewf_info.h.
 */

void EWF_INFO_Initialize ( void )
{
    /* Place the App state machine in its initial state. */
    ewf_infoData.state = EWF_INFO_STATE_INIT;
...
void EWF_INFO_Tasks ( void )
{
    ...
    switch ( ewf_infoData.state )
    {
        /* Application's initial state. */
        case EWF_INFO_STATE_INIT:
        {
            ...
            if (appInitialized)
            {
                ...
                ewf_infoData.state = EWF_INFO_STATE_SERVICE_TASKS;
            }
            break;
        }

        case EWF_INFO_STATE_SERVICE_TASKS:
        {
