...
ewf_adapter* adapter_ptr = NULL;
    ...
    EWF_ADAPTER_THALES_EXS82_W_STATIC_DECLARE(adapter_ptr, exs82_w, message_allocator_ptr, NULL, interface_ptr);
    ...
    if (ewf_result_failed(result = ewf_adapter_thales_exs82_w_context_activate(adapter_ptr, EWF_CONFIG_CONTEXT_ID)))
    {
