...
/**
 * @defgroup group_example_configuration_interface Host interface configuration
 * @brief Host interface configuration settings used in examples
 * @{
 */
...
#define EWF_CONFIG_INTERFACE_WIN32_COM_PORT_BAUD_RATE       (CBR_9600)
