...
#include "test/ewf_adapter_espressif_esp8266_test.c"
...
void thread_sample_entry(ULONG thread_input)
{
    ...
    if (ewf_result_failed(result = ewf_adapter_espressif_esp8266_test(adapter_ptr)))
    {
...
int main(void)
{
  ...
  MX_USART3_UART_Init();
  /* USER CODE BEGIN 2 */
  EWF_LOG("\n\n[INFO][EXAMPLE INFO ThreadX BG95 shield]\n");
  /* USER CODE END 2 */
