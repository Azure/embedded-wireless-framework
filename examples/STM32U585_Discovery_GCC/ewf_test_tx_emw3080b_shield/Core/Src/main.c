...
#include "ewf_adapter_mxchip_common.c"
#include "ewf_adapter_mxchip_common_tokenizer.c"
#include "ewf_adapter_mxchip_common_wifi_station.c"
#include "ewf_adapter_mxchip_common_urc.c"
#include "ewf_adapter_mxchip_common_control.c"
#include "ewf_adapter_mxchip_common_info.c"
#include "ewf_adapter_mxchip_common_internet.c"
#include "test/ewf_adapter_mxchip_emw3080b_test.c"
...
void thread_sample_entry(ULONG thread_input)
{
    ...
    if (ewf_result_failed(result = ewf_adapter_mxchip_emw3080b_test(adapter_ptr)))
    {
    ...
    if (ewf_result_failed(result = ewf_adapter_wifi_station_disconnect(adapter_ptr)))
    {
        EWF_LOG_ERROR("Failed to disconnect the adapter from the WiFi network, ewf_result %d.\n", result);
        return;
    }
...
int main(void)
{
  ...
  MX_USART3_UART_Init();
  /* USER CODE BEGIN 2 */
  EWF_LOG("\n\n[INFO][EXAMPLE INFO ThreadX MX-CHIP EM3080B shield]\n");
  /* USER CODE END 2 */
